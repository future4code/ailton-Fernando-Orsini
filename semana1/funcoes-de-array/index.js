...
// R: os itens do array original em um novo array.
...
//   a) O que vai ser impresso no console?
// R: Somente os valores "nome" do array original em um novo array.
...
//   a) O que vai ser impresso no console?
// R: Somente os itens que tenham apelidos diferentes ao "Chijo".
...
//     1. Dado o seguinte array de cachorrinhos que são clientes de um pet shop, realize as operações pedidas nos itens abaixo utilizando as funções de array **map** e **filter:**
    ...
    const verificaRaca = (pets, imprimir) => {
    if (raca === "Poodle") {
        const poodleArray = raca
        imprimir(raca)
        
    }
} 
verificaRaca ("Poodle", (nome) => {
...
// ***Incompleta
    ...
    //  d) Crie um novo array que contenha apenas os objetos cujo nome contenha a palavra "Ypê"
     ...
     const marcaYpe = produtos.filter((item, index, array) => {
    ...
    //  e) Crie um novo array onde cada item é uma frase "Compre [NOME] por [PREÇO]". Esse array deve conter frases apenas dos itens cujo nome contenha a palavra "Ypê"
     ...
     const imprimeFrase (marcaYpe) =>{
         const novoYpe = [...marcaYpe]
         novoYpe.item = "Compre", `nome`, "por", `preco`
